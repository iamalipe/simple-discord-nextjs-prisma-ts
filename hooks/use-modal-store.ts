...
//   "editServer" | "members" | "createChannel" | "leaveServer" | "deleteServer" | "deleteChannel" | "editChannel" | "messageFile" | "deleteMessage";

export interface ModalDataInterface {
  category?: Category;
  server?: Server | ServerWithCategoriesAndChannel;
}
